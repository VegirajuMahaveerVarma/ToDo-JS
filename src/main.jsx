...
import { BarChart3, Bell, Check, ChevronRight, Circle, Clock3, Download, Flame, LayoutGrid, ListChecks, Moon, Plus, Search, Settings2, Sparkles, Sun, Target, Trash2, Upload, X, LogOut } from 'lucide-react';
import './styles.css';
import './daily.css';
...
function App() {
  ...
  const logout = () => { if (!window.confirm('Log out of TaskFlow? Your tasks will stay saved on this device.')) return; localStorage.removeItem(PROFILE_STORAGE); setProfile(null); setProfileForm({ name: '', gender: '' }); setView('tasks'); setTab('Today'); setNotice('Logged out successfully.'); };
